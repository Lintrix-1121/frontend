...
//                     {/* First two posts with images and overlay titles */}
...
//                     return (
//                         <div key={blog.blogId} className="mb-5 position-relative">
...
//                             {/* Title Overlay */}
//                             <div className="position-absolute bottom-0 start-0 w-100 p-4 text-white">
//                             <h4 className="fw-bold mb-2" style={{ fontSize: '1.5rem', lineHeight: '1.3' }}>
//                                 {blog.title}
//                             </h4>
...
//                     {/* Additional Blog Summaries with small thumbnail images */}
//                     {recentBlogs.slice(2, 4).map((blog) => {
//                     const imageUrl = blog.featuredImage || blog.featuredImageUrl 
//                         ? constructImageUrl(blog.featuredImage || blog.featuredImageUrl) 
//                         : null;
                    
//                     return (
//                         <div key={blog.blogId} className="mb-4">
//                         <div className="row align-items-center">
//                             {/* Image with text overlay */}
//                             <div className="col-4 position-relative">
//                             <div style={{ height: '120px', overflow: 'hidden' }} className="rounded">
//                                 {imageUrl ? (
//                                 <img 
//                                     src={imageUrl} 
//                                     alt={blog.title}
...
//                             {/* Content */}
//                             <div className="col-8">
//                             <h5 className="fw-bold fs-6 mb-2" style={{ lineHeight: '1.3' }}>
//                                 {blog.title}
//                             </h5>
//                             {blog.excerpt && (
//                                 <p className="text-muted fs-7 mb-2" style={{ lineHeight: '1.4' }}>
//                                 {blog.excerpt.length > 80 ? `${blog.excerpt.substring(0, 80)}...` : blog.excerpt}
//                                 </p>
//                             )}
//                             <a 
//                                 href={`/blog/${blog.slug || blog.blogId}`}
//                                 className="text-dark text-decoration-none fw-medium d-inline-flex align-items-center small"
//                             >
//                                 Read More
...
//                 <div className="p-4 border" style={{ backgroundColor: 'white' }}>
//                     <h3 className="text-uppercase text-success fw-bold fs-5 mb-3">Subscribe Newsletter</h3>
//                     <p className="text-muted mb-4" style={{ fontSize: '0.9rem', lineHeight: '1.6' }}>
//                     Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium 
//                     doloremque laudantium totam.
...
//                     <input 
//                         type="email" 
//                         className="form-control form-control-lg rounded-0 mb-3"
//                         placeholder="Enter your email address"
//                         style={{ 
//                         border: '1px solid #ddd',
//                         boxShadow: 'none'
...
//                     <a 
//                         href="/blog"
//                         className="text-dark text-decoration-none fw-medium px-3 py-2 border border-dark d-inline-block"
//                         style={{ fontSize: '0.9rem' }}
//                     >
//                         [Read More](#)
//                     </a>
