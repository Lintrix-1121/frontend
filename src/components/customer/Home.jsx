            ...
            <div className="col-lg-6">
              ...
              >
                <h1 className="fw-bold display-5 mb-4">
                  Reliable LPG Engineering & Distribution Solutions
                </h1>
                <p className="lead mb-4 opacity-90">
                  Safe. Efficient. Certified. We design, install, and distribute
                  LPG systems for industrial, commercial, and residential clients.
                </p>
        ...
        <div className="container position-relative z-1 py-5">
          <div className="text-start mb-5">
            ...
            <p className="lead text-danger text-start mt-3">
              ...
              your business needs.
              {/* End-to-end LPG solutions built to international safety standards */}
            </p>
          </div>
          ...
          <div className="row g-4">
            {[
              {
                icon: 'bi-tools',
                title: 'LPG Engineering',
                desc: 'Design, installation, testing, and commissioning of LPG systems.',
                color: '#d90429'
              },
              {
                icon: 'bi-truck',
                title: 'LPG Distribution',
                desc: 'Reliable bulk and cylinder LPG supply with controlled logistics.',
                color: '#0b2c5d'
              },
              {
                icon: 'bi-shield-check',
                title: 'Safety & Compliance',
                desc: 'Audits, inspections, leak detection, and regulatory compliance.',
                color: '#28a745'
              }
            ].map((s, i) => (
            ...
            <div className="col-lg-6 mb-4 mb-lg-0">
              ...
              >
                <h2 className="fw-bold display-4 mb-4" style={{ color: '#0b2c5d' }}>
                  Why Choose Our LPG Solutions?
                </h2>
                <p className="lead text-muted mb-4">
                  We combine engineering expertise, safety-first processes,
                  and reliable supply chains to deliver uninterrupted LPG solutions.
                </p>
              </div>

              <div className="row g-3">
                {[
                  { icon: 'bi-award', text: 'Certified engineers & technicians' },
                  { icon: 'bi-shield-check', text: 'Strict safety & quality standards' },
                  { icon: 'bi-clock-history', text: 'On-time distribution & logistics' },
                  { icon: 'bi-headset', text: '24/7 technical support' }
                ].map((item, i) => (
        ...
        <div className="container position-relative z-1">
          <div className="row text-center g-4">
            {[
              ...
              { number: '300+', label: 'Installed Systems', icon: 'bi-gear-wide-connected' },
            ...
            <div className="col-lg-10">
              ...
              >
                ...
                <div className="position-relative z-1">
                  <h2 className="fw-bold display-4 mb-4" style={{ color: '#0b2c5d' }}>
                    Need a Safe & Reliable LPG Partner?
                  </h2>
                  <p className="lead text-muted mb-4 mx-auto" style={{ maxWidth: '700px' }}>
                    Talk to our certified engineers today and get a customized LPG solution tailored to your needs.
                  </p>
                  
                  <div className="d-flex flex-wrap justify-content-center gap-3">
                    {[
                      { icon: 'bi-telephone-outbound', text: 'Call Now', variant: 'danger', outline: false },
                      { icon: 'bi-envelope', text: 'Email Us', variant: 'primary', outline: true },
                      { icon: 'bi-chat-left-text', text: 'Live Chat', variant: 'dark', outline: true }
                    ].map((btn, i) => (
                      <button 
                        key={i}
...
//             <div className="col-lg-6 text-center mt-5 mt-lg-0">
//               <div className="position-relative">
//                 <div className="p-5 rounded-4 d-inline-block"
//                   style={{
//                     backgroundColor: 'rgba(255, 255, 255, 0.1)',
//                     backdropFilter: 'blur(20px)',
//                     border: '1px solid rgba(255, 255, 255, 0.2)',
...
//               <div className="col-md-4" key={i}>
//                 <div
//                   className="h-100 p-5 text-center rounded-4"
//                   style={{
//                     backgroundColor: 'rgba(255, 255, 255, 0.4)',
//                     backdropFilter: 'blur(20px) saturate(180%)',
//                     WebkitBackdropFilter: 'blur(20px) saturate(180%)',
...
//                 >
//                   <div 
//                     className="d-inline-flex align-items-center justify-content-center mb-4 rounded-circle p-3"
//                     style={{
//                       backgroundColor: 'rgba(255, 255, 255, 0.8)',
//                       backdropFilter: 'blur(10px)',
//                       border: `2px solid ${s.color}30`,
...
//         <div className="container py-5 position-relative z-1">
//           <div className="p-4 p-lg-5 rounded-4 mb-5"
//             style={{
//               backgroundColor: 'rgba(255, 255, 255, 0.6)',
//               backdropFilter: 'blur(20px)',
//               border: '1px solid rgba(255, 255, 255, 0.4)',
...
//           <div className="row align-items-center">
//             <div className="col-lg-6 mb-4 mb-lg-0">
//               <div className="p-4 p-lg-5 rounded-4 mb-4"
//                 style={{
//                   backgroundColor: 'rgba(255, 255, 255, 0.6)',
//                   backdropFilter: 'blur(15px)',
//                   border: '1px solid rgba(255, 255, 255, 0.4)'
...
//                 ].map((item, i) => (
//                   <div className="col-md-6" key={i}>
//                     <div className="d-flex align-items-start p-4 rounded-3 h-100"
//                       style={{
//                         backgroundColor: 'rgba(255, 255, 255, 0.5)',
//                         backdropFilter: 'blur(10px)',
//                         border: '1px solid rgba(255, 255, 255, 0.3)',
...
//             ].map((stat, i) => (
//               <div className="col-6 col-md-3" key={i}>
//                 <div className="p-4 p-lg-5 rounded-4 h-100"
//                   style={{
//                     backgroundColor: 'rgba(255, 255, 255, 0.15)',
//                     backdropFilter: 'blur(15px) saturate(180%)',
//                     border: '1px solid rgba(255, 255, 255, 0.25)',
...
//           <div className="row justify-content-center">
//             <div className="col-lg-10">
//               <div className="p-5 p-lg-6 rounded-4"
//                 style={{
//                   backgroundColor: 'rgba(255, 255, 255, 0.85)',
//                   backdropFilter: 'blur(30px) saturate(180%)',
//                   border: '1px solid rgba(255, 255, 255, 0.6)',
...
//                   <div className="mt-5 pt-3">
//                     <div className="d-inline-flex align-items-center gap-3 p-3 rounded-3"
//                       style={{
//                         backgroundColor: 'rgba(11, 44, 93, 0.1)',
//                         backdropFilter: 'blur(10px)',
//                         border: '1px solid rgba(11, 44, 93, 0.2)'
