...
//   useEffect(() => {
//     if (activeTab === 'orders' && selectedCustomer) {
//       fetchCustomerOrders(selectedCustomer.id, ordersPage);
//     } else if (activeTab === 'activity' && selectedCustomer) {
//       fetchCustomerActivity(selectedCustomer.id);
//     }
//   }, [activeTab, selectedCustomer, ordersPage]);
...
//           <div className="d-flex align-items-center gap-3">
//             <img
//               src={customer.profilePicture || `https://ui-avatars.com/api/?name=${customer.userName}&background=random&size=64`}
//               alt={customer.userName}
//               className="rounded-circle"
//               width="64"
//               height="64"
...
//           <StatCard
//             title="Total Spent"
//             value={customer.getLifetimeValue()}
//             icon={DollarSign}
//             trend="+8%"
//             trendUp={true}
//           />
...
//           <StatCard
//             title="Avg Order Value"
//             value={customer.getAverageOrderValueFormatted()}
//             icon={Package}
//           />
//         </div>
...
//             icon={Calendar}
//             subtitle={customer.getCustomerSince()}
//           />
//         </div>
//       </div>
...
//                     <div className="fw-medium">
//                       {customer.lastLoginAt 
//                         ? customer.lastLoginAt.toLocaleString() 
//                         : 'Never'}
//                     </div>
//                   </div>
//                 </div>
...
//                   <dt className="col-sm-4">Provider</dt>
//                   <dd className="col-sm-8 text-capitalize">{customer.provider}</dd>
                  
//                   <dt className="col-sm-4">Provider ID</dt>
//                   <dd className="col-sm-8">{customer.providerId || 'N/A'}</dd>
                  
//                   <dt className="col-sm-4">Created</dt>
//                   <dd className="col-sm-8">{customer.createdAt.toLocaleString()}</dd>
                  
//                   <dt className="col-sm-4">Last Updated</dt>
//                   <dd className="col-sm-8">{customer.updatedAt.toLocaleString()}</dd>
//                 </dl>
//               </div>
//             </div>
//           </div>
...
//                 <dl className="row mb-0">
//                   <dt className="col-sm-6">Total Orders</dt>
//                   <dd className="col-sm-6">{customer.totalOrders}</dd>
                  
//                   <dt className="col-sm-6">Total Spent</dt>
//                   <dd className="col-sm-6">{customer.getLifetimeValue()}</dd>
                  
//                   <dt className="col-sm-6">Average Order Value</dt>
//                   <dd className="col-sm-6">{customer.getAverageOrderValueFormatted()}</dd>
