  ...
  if (loading && !currentService) {
    return (
      <div className="container py-5 text-center" style={{
        ...
        <div className="spinner-border text-primary" role="status" style={{ borderRadius: '0' }}>
  ...
  return (
    <div className="container py-4" style={{
      ...
      <div className="row mb-4">
        ...
        {/* Admin Actions (Only show in admin view) */}
        {isAdminView && (
      ...
      <div className="row">
        ...
        <div className="col-lg-8">
          <div className="row">
            ...
            {/* Related Services - Only show in admin view */}
        ...
        <div className="col-lg-4">
          {/* Details Card - Show different info based on view */}
          ...
          {/* Quick Actions - Only show in admin view */}
          {isAdminView && (
            <div style={{
              background: 'rgba(255, 255, 255, 0.1)',
              backdropFilter: 'blur(10px)',
...
//           <Link to={backUrl} className="btn btn-outline-warning">
//             Back to Services
//           </Link>
//         </div>
//       </div>
...
//               Back to Services
//             </Link>
//             <h1 className="h2 mb-0">{currentService?.title}</h1>
//             {isAdminView && (
//               <span className={`badge bg-${currentService?.isActive ? 'success' : 'secondary'} ms-3`}>
//                 {currentService?.isActive ? 'Active' : 'Inactive'}
//               </span>
//             )}
//           </div>
//           {currentService?.subTitle && (
//             <p className="lead text-muted">{currentService.subTitle}</p>
//           )}
//         </div>
...
//                     <h5 className="mb-0">Related Services</h5>
//                     <button
...
//                     ) : (
//                       <div className="text-center py-4">
//                         <i className="bi bi-link text-muted mb-3" style={{ fontSize: '3rem' }}></i>
//                         <h5>No related services</h5>
...
//                     <span>{currentService?.serviceId}</span>
//                   </li>
//                   <li className="list-group-item d-flex justify-content-between">
//                     <span className="text-muted">Display Order</span>
//                     <span className="badge bg-info">{currentService?.order}</span>
//                   </li>
//                   <li className="list-group-item d-flex justify-content-between">
//                     <span className="text-muted">Status</span>
//                     <span className={`badge bg-${currentService?.isActive ? 'success' : 'secondary'}`}>
//                       {currentService?.isActive ? 'Active' : 'Inactive'}
//                     </span>
//                   </li>
//                 </>
...
//                 </div>
//                 {isAdminView && (
//                   <code className="text-muted">{currentService.icon}</code>
//                 )}
//               </div>
//             </div>
//           )}
...
//             <div className="card">
//               <div className="card-header">
//                 <h6 className="mb-0">Interested in this service?</h6>
//               </div>
//               <div className="card-body">
//                 <div className="d-grid gap-2">
//                   <Link
...
//       {isAdminView && (
//         <>
//           <div className={`modal fade ${showLinkModal ? 'show' : ''}`} style={{ display: showLinkModal ? 'block' : 'none' }}>
//             <div className="modal-dialog modal-lg">
//               <div className="modal-content">
//                 <div className="modal-header">
//                   <h5 className="modal-title">Link Related Service</h5>
//                   <button type="button" className="btn-close" onClick={() => setShowLinkModal(false)}></button>
//                 </div>
//                 <div className="modal-body">
//                   <div className="mb-3">
//                     <label className="form-label">Select Service to Link</label>
//                     <select
//                       className="form-select"
//                       value={selectedServiceId}
//                       onChange={(e) => setSelectedServiceId(e.target.value)}
...
//                               {selected.subTitle && (
//                                 <p className="text-muted mb-0">{selected.subTitle}</p>
//                               )}
//                             </div>
//                           ) : null;
//                         })()}
...
//             </div>
//           </div>
//           {showLinkModal && <div className="modal-backdrop fade show"></div>}
//         </>
//       )}
//     </div>
//   );
